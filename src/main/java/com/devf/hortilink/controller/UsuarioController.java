...
public class UsuarioController {
	...
	public ResponseEntity<Void> atualizarPerfil(@RequestAttribute("userId") Long userId, @RequestBody PerfilCompradorDTO dto) {
	...
	@PutMapping("/{id}/foto")
	public ResponseEntity<Void> atualizarFoto(@PathVariable Long id, @RequestBody Foto foto) {
